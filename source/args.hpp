...
namespace octave_ndjson::args
{
    ...
    struct ParsedArgs
    {
        ...
        ParseMode   m_mode      = ParseMode::Strict;
        Threading   m_threading = Threading::Multi;
    };

    inline std::optional<ParseMode> parse_mode_from_string(std::string_view str)
    {
        // clang-format off
    ...
    inline std::optional<Threading> threading_from_string(std::string_view str)
    {
        // clang-format off
    ...
    inline ParsedArgs parse(const octave_value_list& args, Kind kind, const char* error_prefix)
    {
        ...
        while (i < size) {
            ...
            if (param == "mode") {
                ...
                auto mode  = parse_mode_from_string(value);
                ...
                auto mode  = threading_from_string(value);
